...
struct MotionManagerViewModifier: ViewModifier {
    ...
    func body(content: Content) -> some View {
        ...
        content
            ...
            .environment(\.motionUpdatesEnabled, motionManager.motionUpdatesEnabled(id: registrationID))
            .onAppear {
...
public extension View {
    ...
    /// - Returns: View with ``MotionManager``, ``DeviceRotation``, and ``SwiftUICore/EnvironmentValues/motionUpdatesEnabled`` in the environment
